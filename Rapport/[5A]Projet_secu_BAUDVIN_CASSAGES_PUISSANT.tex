...
\begin{abstract}
\acrshort{alca} est un projet libre de contrôle d'accès au réseau, un \gls{NAC}. Au sein de ce dernier, il est possible de retrouver l'utilisation du protocole NetFlow. ALCASAR bénéficie alors d'une sonde réseau lui permettant d'analyser les flux réseaux le traversant avec beaucoup de finesse.\\
